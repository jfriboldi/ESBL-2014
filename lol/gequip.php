...
$sql = mysqli_query($con, "select equips.id, equips.nome, equips.top, equips.jg, equips.mid, equips.adc, equips.sup, equips.logo, sum(class.pts) as tp from class inner join equips on equips.id = class.id_equip group by equips.id order by equips.nome limit $n, 4 ");
